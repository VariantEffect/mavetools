...
class Test(TestCase):
    ...
    def test_four_base_change(self):
        ...
        self.assertEqual(legacy_to_mave_hgvs_nt("c.[1C>A;2A>C;8G>T;9T>C]"), "c.[1_2delinsAC;8_9delinsTC]")

    def test_five_base_change(self):
        # test five base change
        target_seq = "CAATTTGGTTGGTCTGCTAATATGGAA"
        self.assertEqual(legacy_to_mave_hgvs_nt("c.[1C>A;7G>C;8G>T;9T>C;10T>G]"),
