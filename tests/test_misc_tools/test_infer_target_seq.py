...
class Test(TestCase):
    ...
    def test_incomplete_data(self):
        # note that in situations where the beginning or end of target seq is not covered by variants
        # the inferred sequence will have no gaps, but still not match the actual target seq
        target_seq = "CAATTTGGTTGGTCTGCTAATATGGAA"
        variant_list = [
            Variant("n.1C>A"),
            Variant("n.2A>C"),
